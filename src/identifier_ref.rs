...
impl IdRef {
    ...
    /// ```
    pub const fn bit_string() -> &'static Self {
    ...
    /// assert_eq!(0x03, id.number().unwrap().get());
    /// ```
    pub const fn bit_string_constructed() -> &'static Self {
    ...
    /// ```
    pub const fn object_identifier() -> &'static Self {
    ...
    /// ```
    pub const fn object_descriptor() -> &'static Self {
    ...
    /// ```
    pub const fn external() -> &'static Self {
    ...
    /// ```
    pub const fn enumerated() -> &'static Self {
    ...
    /// ```
    pub const fn embedded_pdv() -> &'static Self {
    ...
    /// ```
    pub const fn relative_oid() -> &'static Self {
    ...
    /// ```
    pub const fn numeric_string() -> &'static Self {
    ...
    /// assert_eq!(0x12, id.number().unwrap().get());
    /// ```
    pub const fn numeric_string_constructed() -> &'static Self {
    ...
    /// ```
    pub const fn printable_string() -> &'static Self {
    ...
    /// assert_eq!(0x13, id.number().unwrap().get());
    /// ```
    pub const fn printable_string_constructed() -> &'static Self {
    ...
    /// ```
    pub const fn t61_string() -> &'static Self {
    ...
    /// assert_eq!(0x14, id.number().unwrap().get());
    /// ```
    pub const fn t61_string_constructed() -> &'static Self {
    ...
    /// ```
    pub const fn videotex_string() -> &'static Self {
    ...
    /// assert_eq!(0x15, id.number().unwrap().get());
    /// ```
    pub const fn videotex_string_constructed() -> &'static Self {
    ...
    /// ```
    pub const fn ia5_string() -> &'static Self {
    ...
    /// assert_eq!(0x16, id.number().unwrap().get());
    /// ```
    pub const fn ia5_string_constructed() -> &'static Self {
    ...
    /// ```
    pub const fn utc_time() -> &'static Self {
    ...
    /// assert_eq!(0x17, id.number().unwrap().get());
    /// ```
    pub const fn utc_time_constructed() -> &'static Self {
    ...
    /// ```
    pub const fn generalized_time() -> &'static Self {
    ...
    /// assert_eq!(0x18, id.number().unwrap().get());
    /// ```
    pub const fn generalized_time_constructed() -> &'static Self {
    ...
    /// ```
    pub const fn graphic_string() -> &'static Self {
    ...
    /// assert_eq!(0x19, id.number().unwrap().get());
    /// ```
    pub const fn graphic_string_constructed() -> &'static Self {
    ...
    /// ```
    pub const fn visible_string() -> &'static Self {
    ...
    /// assert_eq!(0x1a, id.number().unwrap().get());
    /// ```
    pub const fn visible_string_constructed() -> &'static Self {
    ...
    /// ```
    pub const fn general_string() -> &'static Self {
    ...
    /// assert_eq!(0x1b, id.number().unwrap().get());
    /// ```
    pub const fn general_string_constructed() -> &'static Self {
    ...
    /// ```
    pub const fn universal_string() -> &'static Self {
    ...
    /// assert_eq!(0x1c, id.number().unwrap().get());
    /// ```
    pub const fn universal_string_constructed() -> &'static Self {
    ...
    /// ```
    pub const fn character_string() -> &'static Self {
    ...
    /// assert_eq!(0x1d, id.number().unwrap().get());
    /// ```
    pub const fn character_string_constructed() -> &'static Self {
    ...
    /// ```
    pub const fn bmp_string() -> &'static Self {
    ...
    /// assert_eq!(0x1e, id.number().unwrap().get());
    /// ```
    pub const fn bmp_string_constructed() -> &'static Self {
