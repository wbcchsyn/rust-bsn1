...
#[bsn1_serde]
struct B {
    #[bsn1_serde(skip_serializing, skip_deserializing, default = "Default::default")]
    _x: i32,
}
...
#[bsn1_serde(id = Set)]
struct C {
    #[bsn1_serde(skip_serializing, skip_deserializing, default = "two")]
    _x: i32,
    y: String,
}
...
#[derive(bsn1_serde::Serialize, bsn1_serde::Deserialize, Debug, PartialEq)]
#[bsn1_serde(id = Set, tag_class = CONTEXT_SPECIFIC)]
struct E {
    x: i32,
    #[bsn1_serde(skip_serializing, skip_deserializing, default = "bar")]
    _y: String,
    z: bool,
}
...
struct F(#[bsn1_serde(skip_serializing, skip_deserializing, default = "two")] i32);

#[derive(bsn1_serde::Serialize, bsn1_serde::Deserialize, Debug, PartialEq)]
#[bsn1_serde(id = Set, tag_pc = PRIMITIVE)]
struct G(
    #[bsn1_serde(skip_serializing, skip_deserializing, default = "Default::default")] i32,
    String,
);

#[derive(bsn1_serde::Serialize, bsn1_serde::Deserialize, Debug, PartialEq)]
#[bsn1_serde(tag_class = CONTEXT_SPECIFIC, tag_pc = PRIMITIVE)]
struct H(
    i32,
    #[bsn1_serde(skip_serializing, skip_deserializing, default = "bar")] String,
);

#[derive(bsn1_serde::Serialize, bsn1_serde::Deserialize, Debug, PartialEq)]
#[bsn1_serde(id = Set, tag_class = CONTEXT_SPECIFIC, tag_pc = PRIMITIVE)]
struct I(
    i32,
    #[bsn1_serde(skip_serializing, skip_deserializing, default = "Default::default")] String,
    bool,
);
...
enum X {
    ...
    #[bsn1_serde(id = Set, tag_class = CONTEXT_SPECIFIC, tag_num = 0x1f)]
    M {
        x: i32,
        #[bsn1_serde(skip_serializing, skip_deserializing, default = "Default::default")]
        _y: String,
    ...
    N(#[bsn1_serde(skip_serializing, skip_deserializing, default = "Default::default")] i32),
    #[bsn1_serde(id = Set, tag_pc = PRIMITIVE, tag_num = 0x80)]
    O(
        #[bsn1_serde(skip_serializing, skip_deserializing, default = "two")] i32,
        String,
    ),
    #[bsn1_serde(tag_class = CONTEXT_SPECIFIC, tag_pc = PRIMITIVE, tag_num = 0x3fff)]
    P(
        i32,
        #[bsn1_serde(skip_serializing, skip_deserializing, default = "Default::default")] String,
    ),
